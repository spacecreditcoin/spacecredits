...
static void usage(const char *cmd) {
    ...
    printf("\t-d\t\tUse SpaceCreditsd instead of Argon2i (which is the default)\n");
...
/*
Runs SpaceCredits with certain inputs and parameters, inputs not cleared. Prints the
