...
// Copyright (c) 2015 The SpaceCredits developers
...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x0003ae05ea72ca5ed3e9726c2ad70e97defde9558ee159e7b31e0ed783272872");
uint256 hashGenesisBlockTestNet("0x0003ae05ea72ca5ed3e9726c2ad70e97defde9558ee159e7b31e0ed783272872");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0xece540fa759bd20a83acb20a06592159858b6d5c068bc9e8ed077a2accacaf33");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1456774601;
static const unsigned int timeGenesisBlockTestNet =1456774601;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=1601;
static const unsigned int nNonceGenesisTestNet=1601;
//----------------------------------------------------
...
const string strMessageMagic = "SpaceCredits Signed Message:\n";
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since SpaceCredits version 2.0 at block 100,000]
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Ohmygodohmygodohmygod! I'm in space!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xb4, 0xa0, 0xc3, 0xe4 };
