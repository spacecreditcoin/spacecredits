...
const QString BITCOIN_IPC_PREFIX("SpaceCredits:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click SpaceCredits: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start SpaceCredits: click-to-pay handler");
    else
...
{
    // clicking on SpaceCredits: URLs creates FileOpen events on the Mac:
